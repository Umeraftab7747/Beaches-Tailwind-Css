...
function Destination() {
  return (
    <div className="max-w-[1240px] mx-auto py-16 px-4 text-center">
      ...
      <p className="py-4 text-2xl font-bold">On the Caribbean's Best Beaches</p>
      <div className="grid grid-rows-none md:grid-cols-5 gap-2 md:gap-4 transition-all duration-100">
        <img
